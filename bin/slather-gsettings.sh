...
gnome_settings_customize_keyboard_navigation() {
  ...
  #   "Keyboard Shortcuts > Navigation > Move to workspace on the right: <Super>PageDown"
  #   "Keyboard Shortcuts > Navigation > Move window one monitor to the left: <Shift><Super>Left"
  #   "Keyboard Shortcuts > Navigation > Move window one monitor to the right: <Shift><Super>Right"
  #   "Keyboard Shortcuts > Navigation > Move window one monitor up: <Shift><Super>Up"
  #   "Keyboard Shortcuts > Navigation > Move window one workspace to the left: <Shift><Super>PageUp"
  #   "Keyboard Shortcuts > Navigation > Move window one workspace to the right: <Shift><Super>PageDown"
  #   "Keyboard Shortcuts > Navigation > Move window to last workspace: <Shift><Super>End"
  #   "Keyboard Shortcuts > Navigation > Move window to workspace 1: <Shift><Super>Home"
...
gnome_settings_customize_keyboard_windows() {
  ...
  #   "Keyboard Shortcuts > Windows > Hide window: <Super>h"
  #   "Keyboard Shortcuts > Windows > Lower window below other windows: Disabled"
  #   "Keyboard Shortcuts > Windows > Maximize window: <Super>Up"
  ...
  #   "Keyboard Shortcuts > Windows > Resize window: <Super>Down"
  ...
  #   "Keyboard Shortcuts > Windows > View split on left: <Super>Left"
  #   "Keyboard Shortcuts > Windows > View split on right: <Super>Right"
  :
}
